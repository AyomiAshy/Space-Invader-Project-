...
# Player
playerImg = pygame.transform.scale(pygame.image.load('Spaceship.png'), (PLAYER_SIZE, PLAYER_SIZE))
...
for _ in range(num_of_enemies):
    enemyImg.append(pygame.transform.scale(pygame.image.load('Alien.png'), (48, 48)))
